...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vsv6qxw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vsv6qxw.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-vsv6qxw.git
cd container-vsv6qxw
```
...
```
docker attach container-vsv6qxw
```
